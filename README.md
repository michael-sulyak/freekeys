...
* $me->config(название_переменной, default_значение) - получение настроек<br>
* * Список настроек<br>
* * * auth - авторизирован ли пользователь (true/false)<br>
* * * level - уровень пользователя<br>
* * * user - массив с данными о пользователе<br>
* * * И все остальные настройки из config.json<br>
